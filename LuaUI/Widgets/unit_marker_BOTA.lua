...
unitList["BOTA"]["arm_t2_def_retaliator"] =               { markerText = "Nuke" }
unitList["BOTA"]["core_t2_def_silencer"] =                { markerText = "Nuke" }
unitList["BOTA"]["arm_t2_def_protector"] =                { markerText = "Anti Nuke" }
unitList["BOTA"]["core_t2_def_fortitudemissiledefense"] = { markerText = "Anti Nuke" }
unitList["BOTA"]["arm_t2_def_stunner"] =                  { markerText = "Stunner" }
unitList["BOTA"]["core_t2_def_neutron"] =                 { markerText = "Neutron" }
