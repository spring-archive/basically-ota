...
modConfig["BOTA"] = {}
modConfig["BOTA"]["unitList"] = 
							{ 
								arm_t1_def_defender = { weapons = { 1 } },
								arm_t1_def_guardian = { weapons = { 1 } },
								arm_t1_def_sentinel = { weapons = { 1 } },
								arm_t1_def_llt = { weapons = { 1 } },
								arm_t2_seadef_defender = { weapons = { 1 } },
								arm_t2_seadef_stingray = { weapons = { 1 } },
								arm_t2_seadef_torpedolauncher = { weapons = { 1 } },
								arm_t2_def_ambusher = { weapons = { 1 } },
								arm_t2_def_annihilator = { weapons = { 1 } },
								arm_t2_def_bigbertha = { weapons = { 1 } },
								arm_t2_def_flakker = { weapons = { 2 } },
								arm_t2_def_protector = { weapons = { 3 } },
								arm_t2_def_retaliator = { weapons = { 1 } },
								arm_t2_def_stunner = { weapons = { 1 } },
								arm_t2_def_vulcan = { weapons = { 1 } },
								arm_t2_seadef_advancedtorpedolauncher = { weapons = { 1 } },
								core_t1_def_gaatgun = { weapons = { 1 } },
								core_t1_def_immolator = { weapons = { 1 } },
								core_t1_def_lightLaserTower = { weapons = { 1 } },
								core_t1_def_pulverizer = { weapons = { 1 } },
								core_t1_def_punisher = { weapons = { 1 } },
								core_t1_def_viper = { weapons = { 1 } },
								core_t1_seadef_stinger = { weapons = { 1 } },
								core_t1_seadef_thunderbolt = { weapons = { 1 } },
								core_t1_seadef_torpedolauncher = { weapons = { 1 } },
								core_t2_def_buzzsaw = { weapons = { 1 } },
								core_t2_def_cobra = { weapons = { 2 } },
								core_t2_def_doomsdaymachine = { weapons = { 1 } },
								core_t2_def_fortitudemissiledefense = { weapons = { 3 } },
								core_t2_def_intimidator = { weapons = { 1 } },
								core_t2_def_neutron = { weapons = { 1 } },
								core_t2_def_silencer = { weapons = { 1 } },
								core_t2_def_toaster = { weapons = { 1 } },
								core_t2_seadef_advancedtorpedolauncher = { weapons = { 1 } },
							}
...
modConfig["BOTA"]["armorTags"] = {}
modConfig["BOTA"]["armorTags"]["air"] = "planes"
modConfig["BOTA"]["armorTags"]["ground"] = "default"
modConfig["BOTA"]["dps"] = {}
modConfig["BOTA"]["dps"]["ground"] = {}
modConfig["BOTA"]["dps"]["air"] = {}
modConfig["BOTA"]["dps"]["ground"]["min"] = 50
modConfig["BOTA"]["dps"]["ground"]["max"] = 500
modConfig["BOTA"]["dps"]["air"]["min"] = 80
modConfig["BOTA"]["dps"]["air"]["max"] = 500
--end of dps-colors
--implement this if you want custom colors
--[[
modConfig["BOTA"]["color"] = {}
modConfig["BOTA"]["color"]["enemy"] = {}
modConfig["BOTA"]["color"]["enemy"]["ground"] = {}
modConfig["BOTA"]["color"]["enemy"]["air"] = {}
modConfig["BOTA"]["color"]["enemy"]["nuke"] = {}									 
modConfig["BOTA"]["color"]["enemy"]["ground"]["min"] = { 1.0, 0.0, 0.0 }
modConfig["BOTA"]["color"]["enemy"]["ground"]["max"] = { 1.0, 1.0, 0.0 }
modConfig["BOTA"]["color"]["enemy"]["air"]["min"] = { 0.0, 1.0, 0.0 }
modConfig["BOTA"]["color"]["enemy"]["air"]["max"] = { 0.0, 0.0, 1.0 }
modConfig["BOTA"]["color"]["enemy"]["nuke"] =  { 1.0, 1.0, 1.0 }
modConfig["BOTA"]["color"]["ally"] = modConfig["BOTA"]["color"]["enemy"]
--]]
